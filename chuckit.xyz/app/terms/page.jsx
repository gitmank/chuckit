        ...
        <main className="flex flex-col h-screen w-screen gap-8 justify-start p-10 lg:p-24 items-center">
            ...
            <div className="flex flex-col gap-4 text-left">
                <p className="text-left">
                    ...
                    between the developer, MANOMAY ARUN KAGALKAR, ( “Website
                    Owner” or “we” or “us” or “our”) and you (“you” or “your”)
            ...
            <ul className="flex flex-col h-max w-3/4 gap-4 items-start justify-start text-left text-sm">
                <li>
            ...
            <p className="pb-4">
                For support, contact &nbsp;
                <a className="text-blue-500" href="support@chuckit.xyz">
                    support@chuckit.xyz
                </a>
            </p>
        </main>
